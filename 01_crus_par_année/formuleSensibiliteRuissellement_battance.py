...
annees = ["2015", "2016", "2017", "2020"]

fichierRasterPentes = "pente_note.tif"
fichierRasterPermea = "permeabilite.tif"
fichierRasterOccSol = "occupation_territoire.tif"
fichierRasterBattance = "battence.tif"
...
for annee in annees:
    print(annee)
    fichierRasterPentes = annee + "\\" + "pente_note.tif"
    fichierRasterPermea = annee + "\\" + "permeabilite.tif"
    fichierRasterOccSol = annee + "\\" + "occupation_territoire.tif"
    fichierRasterBattance = annee + "\\" + "battence.tif"
    
    fichierSortieCRUS_battance = annee + "\\" + "SensibiliteProdRuiss_Bat2.tif"
    fichierSortieCRUS_DiffsansBattance = annee + "\\" + "Difference_Bat_SsBat2.tif"
